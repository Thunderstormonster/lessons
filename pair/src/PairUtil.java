public class PairUtil {
    ...
    public static void main(String[] args) {
        Pair pair1=new Pair<String>("123","345");
        Pair pair2=new Pair<Integer>(123,345);
        Pair pair4=new Pair<String>("123","345");
        ...
        pairUtil.Swap(pair4);
        System.out.println("function Swap for pair4(\"123\",\"345\"): "+pair4.getFirst()+","+pair4.getSecond());
    }
}
